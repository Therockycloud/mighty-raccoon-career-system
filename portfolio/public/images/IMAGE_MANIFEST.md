# Image manifest & QA — 2026-08-10

| File | Tier | Verdict | Notes |
|---|---|---|---|
| `demandcast/dc-ui-overview.png` | A | **PASS** | Live UI; publisher + Stage 2B honesty visible |
| `demandcast/dc-ui-evaluation.png` | A | **PASS** | Lockbox consumed JSON surface |
| `demandcast/dc-ui-operations.png` | A | **PASS** | Ops status view |
| `demandcast/dc-api-docs.png` | A | **PASS** | FastAPI OpenAPI surface |
...
- dc-ui-overview: “DemandCast evidence dashboard — serving publisher `zero+empirical×0.75` after Stage 2B reject.”
- dc-ui-evaluation: “Evaluation API payload — lockbox consumed; Stage 1 champion retained.”
